package olive.olivegreen.rssfeed.adapter;
...
ImageView imageView = (ImageView) rowView.findViewById(R.id.feed_image);
        try {
        	...
        	Log.e("IMG Link", "Image Link" +imageAndTexts1.get(position).getImgLink());
        	
        	Log.e("Web URL", "Web URL" +imageAndTexts1.get(position).getUrl());
